...
macx {
    ...
    OPENSSL_INCLUDE_PATH=/usr/local/cellar/openssl/1.0.2a-1/include
    OPENSSL_LIB_PATH=/usr/local/cellar/openssl/1.0.2a-1/lib
...
macx:ICON = src/qt/res/icons/bubble.icns
macx:TARGET = "Bubble-Qt"
