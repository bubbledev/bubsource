...
static const int64_t nTargetTimespan = 60 * 60;  // Bubble - every 1 hour
unsigned int nTargetSpacing = 1 * 60; // Bubble - 1 minute
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;

static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 6 * 60 * 60; // Bubble - 6 hours
unsigned int nStakeMaxAge = 72 * 60 * 60; // Bubble - 72 hours
unsigned int nModifierInterval = 10 * 60; // Bubble - time to elapse before new modifier is computed
...
const string strMessageMagic = "Bubble Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // bubblecoin: check proof-of-stake block signature
...
// bubblecoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bubble", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Bubble 30 Apr 2015";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 3607208 : 3607208;
        ...
        assert(block.hashMerkleRoot == uint256("0xb3e919ee533c0dd5992237cbcc603ab53648ffe4e6760531fb6495474f6cf234"));
